...
public class ListDocteur extends JFrame {
    ...
    public ListDocteur() {
        ...
        headerPanel.setBackground(new Color(100, 100, 150)); // MS blue
        headerPanel.setBorder(new EmptyBorder(10, 15, 10, 15));

        JLabel titleLabel = new JLabel("Docteur  List");
        titleLabel.setForeground(Color.WHITE);
        titleLabel.setFont(new Font("Segoe UI", Font.BOLD, 18));
        headerPanel.add(titleLabel, BorderLayout.WEST);

        // Create refresh button panel
        JButton addButton = createModernButton("Add New Docteur", new Color(0, 120, 215));
        addButton.addActionListener(e -> {
            this.setVisible(false);
            new AddDocteur().setVisible(true);
        });
        ...
        String[] columnNames = {"ID", "Name", "Specialty", "Edit", "Delete" };
        ...
        table.getColumn("Delete").setCellEditor(new ButtonEditor(new JCheckBox(), "Delete") {
            ...
            protected void handleClick(int row) {
                ...
                if (confirm == JOptionPane.YES_OPTION) {
                    F.delete(userId);
                    loadData();
                    JOptionPane.showMessageDialog(ListDocteur.this,
    ...
    private void loadData() {
        ...
        List<DocteurSchema> data = F.paginate();

        for (DocteurSchema user : data) {
    ...
    private void editUser(String userId) {
        DocteurSchema u = F.find(userId);
        DocteurEdit e = new DocteurEdit(userId, u.getName(), u.getPhone(), u.getSpecialty(), u.getPassword());
        setVisible(false);
    }
