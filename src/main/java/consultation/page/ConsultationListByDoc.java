...
import Ordonnance.page.OrdonnanceAdd;
import RendezVous.page.rendezVousAdd;
...
public class ConsultationListByDoc extends JFrame {
    ...
    public ConsultationListByDoc(String name) {
        this.name = name;
        ...
        String[] columnNames = {"ID", "Docteur", "Pation" , "Time", "Add Diagnostic", "Add ordnance"};
        ...
        table.getColumn("Add Diagnostic").setCellRenderer(new ButtonRenderer());
        table.getColumn("Add ordnance").setCellRenderer(new ButtonRenderer());

        table.getColumn("Add Diagnostic").setCellEditor(new ButtonEditor(new JCheckBox(), "Add Diagnostic") {
            @Override
        ...
        table.getColumn("Add ordnance").setCellEditor(new ButtonEditor(new JCheckBox(), "Add ordnance") {
            @Override
            protected void handleClick(int row) {
                String userId = table.getValueAt(row, 0).toString();
                String pas = table.getValueAt(row, 2).toString();

                    OrdonnanceAdd o = new OrdonnanceAdd(name ,pas );
    ...
    private void loadData() {
        ...
        List<ConsultationSchema> data = F.paginateByDoc(this.name);
    ...
    private void editUser(String userId) {
        ...
        rendezVousAdd e = new rendezVousAdd(  u.getPassion() ,name );
    ...
    static class ButtonRenderer extends JButton implements TableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value,
            ...
            if ("Add Diagnostic".equals(value)) {
                setBackground(new Color(0, 120, 215)); // MS blue
                setForeground(Color.WHITE);
            } else if ("Add ordnance".equals(value)) {
    ...
    static abstract class ButtonEditor extends DefaultCellEditor {
        ...
        public ButtonEditor(JCheckBox checkBox, String label) {
            ...
            // Style buttons differently
            if ("Add Diagnostic".equals(label)) {
