...
public class OrdonnanceList extends JFrame {
    private OrdonnanceFuction F = new OrdonnanceFuction();
    private DefaultTableModel model;
    private JTable table;

    public OrdonnanceList( ) {
        ...
        headerPanel.setBackground(new Color(218, 165, 32)); // MS blue
        headerPanel.setBorder(new EmptyBorder(10, 15, 10, 15));

        JLabel titleLabel = new JLabel("rendez-vous List");
        titleLabel.setForeground(Color.WHITE);
        titleLabel.setFont(new Font("Segoe UI", Font.BOLD, 18));
        headerPanel.add(titleLabel, BorderLayout.WEST);

        // Create add button panel
        JButton addButton = createModernButton("Cansel", new Color(100, 12, 2));
...
//            new OrdonnanceAdd().setVisible(true);
    ...
    private void loadData() {
        ...
        List<OrdonnanceSchema> data = F.paginate();
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new OrdonnanceList());
    }
}
