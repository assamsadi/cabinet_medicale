...
public class UserList extends JFrame {
    ...
    public UserList() {
        ...
        headerPanel.setBackground(new Color(100, 150,100)); // MS blue
        ...
        JButton addButton = createModernButton("Add New User", new Color(120, 120, 215));
        ...
        String[] columnNames = {"ID", "Name", "CIN", "Edit", "Delete" , "Add rendez-vous"};
        model = new DefaultTableModel(columnNames, 0) {
            @Override
            public boolean isCellEditable(int row, int column) {
                return column >= 3; // Only the action columns are editable
            }
        };
        ...
        table.getColumn("Add rendez-vous").setCellRenderer(new ButtonRenderer());
        ...
        table.getColumn("Add rendez-vous").setCellEditor(new ButtonEditor(new JCheckBox(), "Add rendez-vous") {
            @Override
            protected void handleClick(int row) {
                String userId = table.getValueAt(row, 0).toString();
                UserSchema u = F.find(userId);
                setVisible(false);
                SwingUtilities.invokeLater(() -> new ConsultationAdd(u.getName()));
            }
        });
    ...
    private void loadData() {
        ...
        List<UserSchema> data = F.paginate();

        for (UserSchema user : data) {
    ...
    private void editUser(String userId) {
        ...
        UserEdit e = new UserEdit(userId, u.getName(), u.getPhone(), u.getCIN(), u.getRole());
        setVisible(false);
    }
